CREATE DATABASE IF NOT EXISTS `english_word_book`;

USE `english_word_book`;

CREATE TABLE IF NOT EXISTS `word_book_list` (
...
CREATE TABLE IF NOT EXISTS `shisutan` (
    id INT(5) NOT NULL PRIMARY KEY,
    english_word VARCHAR(256) NOT NULL,
    japanese_word VARCHAR(256) NOT NULL,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT NULL
);

INSERT INTO `shisutan` (id, english_word, japanese_word)
VALUES 
(1, 'follow', '～の後に続く、～に従う'),
(2, 'consider', '～を考慮する'),
(3, 'increase', '増える、～を増やす'),
